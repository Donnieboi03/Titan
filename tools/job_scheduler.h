...
namespace scheduler
{
    ...
    void JobScheduler::process_jobs_async() noexcept { execute_batch(); }
    
    void JobScheduler::process_jobs_on_async(WorkerId worker_id) noexcept { execute_batch_on(worker_id); }

    
    bool JobScheduler::is_complete() const noexcept { return all_queues_finished(); }

    
    bool JobScheduler::is_complete_on(WorkerId worker_id) const noexcept
    {
    ...
    void JobScheduler::execute_batch() noexcept
    {
    ...
    void JobScheduler::execute_batch_on(WorkerId worker_id) noexcept
    {
